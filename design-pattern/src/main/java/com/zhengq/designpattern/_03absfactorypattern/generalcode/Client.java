 ...
 * 
 * @ClassName: Client
 * @Description: 在场景类中,没有任何一个方法与实现类有关系，对于一个产品来说，<br>
 *               我们只知道它的工厂方法就可以直接产生一个产品对象，无需关心它的实现类。
 *               <p>抽象工厂模式的优点:</p>
 *              ▪  封装性，每个产品的实现类不是高层模块要关心的，它要关心的是什么？是接口，是抽象，它不关心对象是如何创建出来，这由谁负责呢？工厂类，只要知道工厂类是谁，我就能创建出一个需要的对象，省时省力，优秀设计就应该如此。</br>
